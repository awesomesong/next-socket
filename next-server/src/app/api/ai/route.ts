...
export async function POST(req: Request) {
    try {
        ...
        const aiResponse = await generateAIResponse(message, aiAgentType, conversationId);
...
async function generateAIResponse(userMessage: string, aiAgentType: string, conversationId: string): Promise<string> {
    ...
    const possibleResponses = responses[aiAgentType as keyof typeof responses] || responses.assistant;
