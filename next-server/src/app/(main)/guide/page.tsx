...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Scent Memories는 향수를 수집하고 기록하는 프론트엔드 포트폴리오 사이트입니다. 서비스 소개와 이용 방법을 안내합니다.',
    url: "https://www.devsonghee.com/guide",
    images: [
      {
...
const chatConversationGuideSteps: FragranceGuideStep[] = [
  ...
  },
  {
    step: '02',
    title: '대화방 더보기 메뉴(⋮)',
    desc: '"대화방" 제목 오른쪽의 더보기(⋮) 버튼을 클릭하면 다음 세 가지 메뉴가 표시됩니다. ① 단체 채팅: 여러 멤버가 함께 참여하는 그룹 채팅방을 만들 수 있습니다. ② AI 채팅: 향수 AI 어시스턴트와의 채팅방으로 바로 이동합니다. ③ 다크 모드 / 라이트 모드: 현재 테마를 즉시 전환합니다.',
