...
export const ADD_POST_FILES = gql`
	mutation AddPostFiles($name: String, $lastModified: Int, $lastModifiedDate: String, $size: Int, $type: String) {
		addPostFiles(name: $name, lastModified: $lastModified, lastModifiedDate: $lastModifiedDate, size: $size, type: $type) {
			filesId
			name
			size
			type
